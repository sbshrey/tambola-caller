...
**[Download the signed Android APK (v1.1.0)](https://github.com/sbshrey/tambola-caller/releases/download/keyboard-v1.1.0/Tambola-Keyboard-1.1.0.apk)** · [Release notes](https://github.com/sbshrey/tambola-caller/releases/tag/keyboard-v1.1.0). Install over an existing version to keep the saved game.
