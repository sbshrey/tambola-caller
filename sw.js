...
const ASSETS = ['./', './index.html', './styles.css', './src/app.js', './src/game.js',
  './src/storage.js', './src/voice.js', './src/sharing.js', './src/audio.js', './manifest.webmanifest', './icon.svg',
...
self.addEventListener('message', (event) => {
  if (event.data?.type === 'offline-version') event.ports[0]?.postMessage({ version: '1.2.0', audioClips: 90 });
});
